...
public class EditProfile extends Activity {
    ...
    public class MyJsonParser extends AsyncTask<Void, Void, Integer>
    {
        EditText editText;
        @Override
        protected Integer doInBackground(Void... params) {
            ...
            try {
                ...
                Log.i("TAG", "update Profile: " + jsonObject);
                int responseCode = connector.putJson(getString(R.string.parentURI)+"/profiles/"+ActiveProfile.getInstance().getId(), jsonObject);
                return responseCode;
            }
